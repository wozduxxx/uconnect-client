...
export default function EditProfileModal({ open, onClose, profile, onSave }) {
    ...
    function handleBannerChange(e) {
        ...
        if (!allowedExtensions.includes(ext)) {
            toast('Неверный формат файла (JPG, PNG)')
            return
        }
        if (file.size > 5 * 1024 * 1024) {
            toast('Файл слишком большой (макс. 5MB)')
            return
        }
                ...
                <div style={{
                    ...
                    {/* Modal */}
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        background: bannerPreview
                                            ...
                                            : 'linear-gradient(135deg,#0f2150,#1e3a8a,#4c1d95)',
                      ...
                      {bannerPreview ? 'Изменить обложку' : 'Загрузить обложку'}
                            ...
                            {/* Text fields — переопределяем цвета под светлый фон */}
                            <div style={{ display: 'flex', flexDirection: 'column' }}>
                                {[
                                    { key: 'name', label: 'Имя', placeholder: 'Ваше имя' },
                                    { key: 'location', label: 'Город', placeholder: 'Москва' },
                                ].map(f => (
                            ...
                            <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
                                ...
                                <Button fullWidth onClick={handleSave} style={{ flex: 1, padding: '13px 0' }}>
                                    Сохранить
                                </Button>
                            </div>
